...
[System.Serializable]
public class ButtonSlotFront
{
    public Transform slotTransform;
    [HideInInspector] public int assignedNumber;
}

public class PuzzleFunctionFront : MonoBehaviour
{
    public bool instable;
    public bool delayCheck;

    public static PuzzleFunctionFront instance { get; private set; }

    [Header("Settings")]
    public GameObject buttonPrefab;
    public ButtonSlotFront[] buttonSlots = new ButtonSlotFront[4];
    ...
    private Dictionary<int, ChangeNumberNoUI> buttonObjects = new Dictionary<int, ChangeNumberNoUI>();
    ...
    {
        // Create a shuffled copy of numbers 1-4
    ...
    private void CreateButton(int number, Transform slot)
    {
        ...
        ChangeNumberNoUI changeNumber = buttonObj.GetComponent<ChangeNumberNoUI>();
        ...
        {
            changeNumber = buttonObj.AddComponent<ChangeNumberNoUI>();
        }
    ...
    public void HandleButtonPress(ChangeNumberNoUI pressedButton)
    {
    ...
    {
        if (nextExpectedNumber > 4) // All buttons pressed in order
        {
